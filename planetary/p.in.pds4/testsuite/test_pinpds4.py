...
class TestPinPds4(TestCase):
    """Test p.in.pds4 module.
    ...
    def test_module_metadata(self):
        ...
        module = SimpleModule("p.in.pds4", flags="", overwrite=False,
                              run_=False)
        # Verify the module binary exists in PATH
        self.assertIsNotNone(shutil.which("p.in.pds4"),
                             "Module p.in.pds4 not found in PATH")
