...
ISIS3 equivalent: isis2std
Purpose: ISIS3 cube import
...
class TestPinIsis(TestCase):
    """Test p.in.isis module.

    Verifies module interface and (where ISIS3 binary is available)
    cross-validates outputs against the equivalent ISIS3 application: isis2std.
    """
    ...
    def test_isis3_equivalence(self):
        ...
        # https://isis.astrogeology.usgs.gov/Application/presentation/Tabbed/isis2std/isis2std.html
